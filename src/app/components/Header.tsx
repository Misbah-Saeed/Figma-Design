      ...
      {/* Main Navigation Bar */}<div className="bg-white shadow py-4">
        ...
        <div>
         <Image
          ...
          <h3 className="text-[#252B42] font-bold  ${montserrat.className} ml-[-350px] text-[24px] leading-8 tracking-[0.1px] ">Furniro</h3>
          ...
          <div className="flex space-x-6 items-center   text-sm text-black">
            ...
            <Link href="/Cart" className="flex items-center hover:text-black font-bold text-[14px] ${montserrat.className} tracking-[0.2px]">
